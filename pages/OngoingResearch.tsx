    ...
    <div className="relative pt-24 md:pt-32 pb-20 overflow-x-hidden">
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="mb-16 md:mb-20 text-left">
          ...
          <p className="text-lg md:text-xl text-indigo-100 font-light max-w-4xl leading-relaxed text-justify">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
            {ONGOING_RESEARCH_PUBLICATIONS.map((pub, idx) => (
              <div key={idx} className="bg-slate-900/60 backdrop-blur-md rounded-[2rem] border border-white/10 p-6 md:p-8 hover:bg-white/10 transition-all group h-full flex flex-col">
                ...
                <p className="text-slate-400 text-xs md:text-sm mb-6 flex-grow leading-relaxed text-justify">{pub.authors}</p>
        ...
        <div className="bg-indigo-900/40 backdrop-blur-xl rounded-[2.5rem] p-8 md:p-16 border border-white/10 shadow-2xl mb-20 md:mb-24 relative overflow-hidden text-left">
          ...
          <div className="relative z-10 max-w-3xl">
            ...
            <div className="space-y-6 text-indigo-100 text-base md:text-lg font-light leading-relaxed text-justify">
              <p>
            ...
            {ONGOING_PROJECTS.map((project) => (
              <div key={project.number} className="bg-slate-900/60 backdrop-blur-md rounded-[2rem] border border-white/10 p-6 md:p-10 hover:bg-white/10 transition-all group flex flex-col sm:flex-row gap-6 md:gap-8">
                ...
                <div>
                  ...
                  <p className="text-slate-300 leading-relaxed text-xs md:text-sm mb-6 font-light text-justify">{project.description}</p>
                  {project.url && (
                    <a 
                      href={project.url} 
                      target="_blank" 
        ...
        <div className="bg-slate-900/60 backdrop-blur-2xl rounded-[2.5rem] p-8 md:p-16 border border-white/10 shadow-2xl text-center">
            ...
            <p className="text-slate-300 max-w-3xl mx-auto leading-relaxed text-sm md:text-lg font-light text-justify">
            ...
            <p className="text-indigo-300 text-[10px] uppercase tracking-[0.3em] font-black drop-shadow-md mt-8">Documenting Over 380 Scientific Contributions</p>
        </div>
      </div>
    </div>
  );
